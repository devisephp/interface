  ...
  <admin-container v-if="languages.data.length">
    <template #message>
      ...
      <a
        ...
        class="dvs-font-bold"
        target="_blank"
        >highly suggest using the ISO 639-1 2 letter codes</a
      >
    ...
    <template #content>
      ...
      <div class="dvs-flex dvs-flex-col">
        ...
        >
          <div
            class="dvs-text-xl dvs-font-bold dvs-mb-4 dvs-p-2 dvs-px-4 dvs-bg-admin-secondary-bg dvs-text-admin-secondary-fg dvs-rounded dvs-shadow dvs-flex-grow"
          >
          ...
          <div class="dvs-flex dvs-justify-between dvs-ml-2 dvs-mb-4 dvs-items-center">
            <button
              ...
              class="dvs-btn dvs-btn-ghost dvs-text-gray-200 dvs-btn-xs dvs-ml-4"
