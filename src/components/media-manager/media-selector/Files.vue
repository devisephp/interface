...
<!-- Files -->
  <ul
    class="dvs-list-reset dvs-flex dvs-items-start dvs-justify-center dvs-flex-wrap"
  >
    <li
    ...
    >
      ...
      >
        ...
        <div
          ...
          class="p-1 flex-grow" 
        >
          <div :style="`height: 300px; background-size:cover;background-image:url('${`/styled/preview/${file.url}?w=300&h=300&q=100&sharp=2`}')`"></div>
        </div>
