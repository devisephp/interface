  ...
  <span class="dvs-text-base">
    <div
      ...
      :class="{
        ...
        'dvs-text-admin-highlight-fg dvs-bg-admin-highlight': !subtle
      }"
      v-if="!compact"
    >
      <div class="dvs-text-admin-highlight dvs-bg-admin-highlight-fg dvs-flex dvs-items-center dvs-justify-center dvs-px-4 dvs-text-xl ">
